...
public final class AdmissionControlGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<admission_control.AdmissionControlOuterClass.SubmitTransactionRequest,
      admission_control.AdmissionControlOuterClass.SubmitTransactionResponse> getSubmitTransactionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SubmitTransaction",
      requestType = admission_control.AdmissionControlOuterClass.SubmitTransactionRequest.class,
      responseType = admission_control.AdmissionControlOuterClass.SubmitTransactionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<admission_control.AdmissionControlOuterClass.SubmitTransactionRequest,
      admission_control.AdmissionControlOuterClass.SubmitTransactionResponse> getSubmitTransactionMethod() {
    io.grpc.MethodDescriptor<admission_control.AdmissionControlOuterClass.SubmitTransactionRequest, admission_control.AdmissionControlOuterClass.SubmitTransactionResponse> getSubmitTransactionMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<types.GetWithProof.UpdateToLatestLedgerRequest,
      types.GetWithProof.UpdateToLatestLedgerResponse> getUpdateToLatestLedgerMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "UpdateToLatestLedger",
      requestType = types.GetWithProof.UpdateToLatestLedgerRequest.class,
      responseType = types.GetWithProof.UpdateToLatestLedgerResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<types.GetWithProof.UpdateToLatestLedgerRequest,
      types.GetWithProof.UpdateToLatestLedgerResponse> getUpdateToLatestLedgerMethod() {
    io.grpc.MethodDescriptor<types.GetWithProof.UpdateToLatestLedgerRequest, types.GetWithProof.UpdateToLatestLedgerResponse> getUpdateToLatestLedgerMethod;
